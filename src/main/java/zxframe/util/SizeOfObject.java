 ...
 * >打包可运行jar
 * >MANIFEST.MF写入
Premain-class: gd10.core.util.SizeOfObject
Can-Redefine-Classes: false
Boot-Class-Path: 
 * >MANIFEST.MF 删除运行class
 * >运行   java -javaagent:test.jar -cp . gd10.core.util.SizeOfObject
 */
public class SizeOfObject {
    ...
    public static void main(String[] args) throws IllegalAccessException {
    	System.out.println("asdf/as".replaceAll("/","."));
	}
}
