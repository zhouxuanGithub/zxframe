...
public class Lesson11Service {
	...
	public Object doTest() {
		...
		User11 user11 = mysqlTemplate.get(User11.class, "79cbc702-9092-4042-b790-5e9523661b8c");//会添加or更新库数据和对应缓存
	...
	public Object doTest2() {
		...
		return mysqlTemplate.get("lesson11MapperSelect");//结果会加入缓存
	}
}
